...
<img class="img-responsive" src="./img/<%=parts[0]+parts[1]%>/<%=parts[0]+parts[1]%>-1.jpg" style="width: 300;height: 299" alt="immagineDivertente">
        </div>
<%   }else{
%>
        <div class="card shadow-sm" style="padding-top: 50px">
<img class="img-responsive" src="./img/<%=videogioco.getTitolo()%>/<%=videogioco.getTitolo()%>-1.jpg" style="width: 300;height: 299" alt="immagineDivertente">
        </div>
            <%}%>
<%}%>
    </div>
