...
/**
 * Servlet per la gestione del proprio profilo da parte dell'autore
 */
...
public class AutoreProfileServlet extends Controllo {
    ...
    /**
     * metodo doGet della Servlet AutoreProfileServlet
     * @param request
     * @param response
    ...
    /**
     * metodo doPost della Servlet AutoreProfileServlet
     * @param request
     * @param response
     * @throws ServletException
     * @throws IOException
